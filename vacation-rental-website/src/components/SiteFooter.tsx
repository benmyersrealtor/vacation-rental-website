...
export function SiteFooter() {
  return (
    <footer className="border-t border-[var(--line)] bg-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-10 lg:py-12">
        <div>
          <Image
          ...
          <p className="mt-4 max-w-md text-sm leading-6 text-[var(--muted)]">
            Vacation rental expertise for Topsail Island, with a modern direct-booking experience layered on top of
